...
| ---------- | ------------ | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **v1.0.0** | January 2026 | ESB Team | Initial release of Generic Template Backoffice Portal.                                                                                                                                                       |
------------------------------------------------------------------------
...
docker build -f Dockerfile.dev -t esb-registry-backoffice-portal:dev .
docker run -p 3000:3000 --env-file .env esb-registry-backoffice-portal:dev
...
docker build -t esb-registry-backoffice-portal .
docker run -p 3000:3000 -e APP_MODE=prod --env-file .env esb-registry-backoffice-portal
```